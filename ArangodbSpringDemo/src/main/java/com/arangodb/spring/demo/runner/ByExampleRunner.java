...
//		final Character nedStark = new Character("洁", "王", false, 41);
//
...
//				.findAll(Example.of(new Character(null, "王", false), ExampleMatcher.matchingAll()
//						.withMatcher("surname", match -> match.exact()).withIgnorePaths("name", "age")));
//		allDeadStarks.forEach(System.out::println);
//
//		System.out.println("## Find all Starks which are 30 years younger than 洁 王");
//		// instead of changing the age for the 洁 王 entity use a transformer within the ExampleMatcher.
